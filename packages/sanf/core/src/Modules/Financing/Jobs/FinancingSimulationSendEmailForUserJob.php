...
namespace Sanf\Core\Modules\Financing\Jobs;
...
class FinancingSimulationSendEmailForUserJob implements ShouldQueue
{
    ...
    public function handle(FinancingSimulationPdfGeneratorService $service)
    {
        $adminMail = config('sanf-mobile.mail_to_admin');
        $reportUrl = "mailto:{$adminMail}?subject=Laporan Hasil Simulasi Pembiayaan";
