...
class SendEmailRequestNewPlafondListener
{
    ...
    public function handle($event)
    {
        ...
        dispatch(new SendEmailNewRequestPlafondForUserJob($data, $profile, [$profile->email]));
        dispatch(new SendEmailNewRequestPlafondForAdminJob($data, $profile, $recipients));
    }
}
