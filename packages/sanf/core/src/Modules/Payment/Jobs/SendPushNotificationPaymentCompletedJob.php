...
class SendPushNotificationPaymentCompletedJob implements ShouldQueue
{
    ...
    public function handle(
        ...
        $body = "Terima kasih! Pembayaran {$totalAmount} atas tagihan Anda telah diterima, silakan cek detail disini.";
        $bodyHtml = "<span>Terima kasih! Pembayaran <b>{$totalAmount}</b> atas tagihan Anda telah diterima, silakan cek detail disini.</span>";
