...
class SendNotificationRejectCommodityJob implements ShouldQueue
{
    ...
    public function handle(AddPushNotificationByExternalService $service)
    {
        $dto = new AddPushNotificationByExternalRequestDto([
            ...
            'title' => __('Pengajuan iklan Komoditas Anda di TOLAK'),
            'subtitle' => __('Info Iklan Komoditas Anda'),
            'screen' => 'my_commodity',
            'body' => __('Mohon maaf pengajuan iklan komoditas anda yang berjudul :title telah ditolak', ['title' => $this->commodity->title]),
