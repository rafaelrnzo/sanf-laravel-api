...
class SendPushNotificationInstallmentOverdueJob implements ShouldQueue
{
    ...
    public function handle(
        ...
        $title = __('Tagihan Anda Sudah Overdue');
        $subtitle = __('Informasi');
        $body = "Tagihan Anda dengan nilai {$totalAmountCurrency} sudah overdue. Cek sekarang untuk melihat rincian biaya keterlambatan dan segera lakukan pembayaran.";
        $bodyHtml = "<span>Tagihan Anda dengan nilai <b>{$totalAmountCurrency}</b> sudah overdue. Cek sekarang untuk melihat rincian biaya keterlambatan dan segera lakukan pembayaran.</span>";
