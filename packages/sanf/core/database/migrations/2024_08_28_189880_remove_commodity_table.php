...
class RemoveCommodityTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection(ConnectionDB::PG_SQL)->drop('commodity');
    }
    ...
    {
        Schema::connection(ConnectionDB::PG_SQL)->create('commodity', function (Blueprint $table) {
        ...
        DB::connection(ConnectionDB::PG_SODIUM)->table('commodity_encrypted')->chunkById(500, function ($data) {
            foreach ($data as $item) {
                ...
                DB::connection(ConnectionDB::PG_SQL)->table('commodity')
                    ->insert(
                        array_merge(
                            $itemArr,
                            [
        ...
        MigrationPostgreSqlUtil::make(ConnectionDB::PG_SQL)->rearrangeSequence('commodity');
    }
}
