...
class CreateCommodityEncryptedTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection(ConnectionDB::PG_SODIUM)->create('commodity_encrypted', function (Blueprint $table) {
            ...
            $table->smallInteger('status_id')->comment('commodity_status.id');
            $table->timestamps();
    ...
    {
        Schema::connection(ConnectionDB::PG_SODIUM)->dropIfExists('commodity_encrypted');
    }
}
