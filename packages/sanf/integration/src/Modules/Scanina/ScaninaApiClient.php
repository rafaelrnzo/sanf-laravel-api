...
//        return $response->json();
    ...
    {
//        $response = Request::route('integration.scanina.product.rent.browse', $this->client)
//            ->queryParams($arguments->toArray())
//            ->send();
//
//        return $response->json();

        return json_decode('{"status":true,"code":"200","message":"OK","data":{"rows":[{"id":"1","shopId":"1","merchantId":"1","serialNumber":"BY-SJJNM-122","name":"Bomang Type 1","nameSlug":"bomang-type-a1","description":"huge truck","imageFiles":{"imageName":"HzZxHWtZO0e16H5tLABQpuGr27dCrGAj3GFKL8jS.jpg","path":"https://minio.nbs.co.id/dev-scan-web-bucket/product/ocXutXa43HfvkdmI6oH5RB6U5jMUavxTs58dJ8l9.jpg?X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=usr_scan_web%2F20230509%2F%2Fs3%2Faws4_request&X-Amz-Date=20230509T030458Z&X-Amz-SignedHeaders=host&X-Amz-Expires=1800&X-Amz-Signature=c15ea2e2291b8c0ca53880f71b69d6cecbb1bf566f85212b2d201532fe2ac139"},"priceBefore":"200000000","price":"100000000","monthPrice":"29999","dayPrice":"830000","hourPrice":"188","startDateAvailable":"1684481832","endDateAvailable":"1684481832","year":"2019","catalogId":"1","catalogName":"truck","locationId":"1002171","locationName":"Batam","conditionTypeId":"1","conditionTypeName":"New","stock":"1","rating":"3","isQualified":"true","isAssurance":"true","latitude":"-6.30064100","longitude":"106.81409500","createdAt":"1683601805","updatedAt":"1683601805"}],"metadata":{"total":1,"count":1,"skip":0,"limit":10,"sort_by":"latest"}}}');
    }
