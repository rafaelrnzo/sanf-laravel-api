      ...
      <div class="sf-content">
          ...
          <ol class="sf-text">
            ...
            <li>
              ...
              <ol type="a" class="sf-text">
                ...
                <li>
                  <p class="sf-text-justify">Setiap data yang tersimpan akan akurat dan/atau bisa diandalkan.</p>
                </li>
                <li>
                  <p class="sf-text-justify">
                ...
                <li>
                  <p class="sf-text-justify">
                    Keamanan, ketepatan waktu, kualitas, kesesuaian, ketersediaan, akurasi dan kelengkapan dari layanan dan/atau Aplikasi.
                  </p>
                </li>
                <li>
                  <p class="sf-text-justify">Layanan dalam Aplikasi akan sesuai dengan harapan dan kebutuhan Pengguna.</p>
                </li>
                <li>
                  <p class="sf-text-justify">
                    Kualitas produk, layanan dan informasi yang tersedia akan memenuhi harapan dan kebutuhan Pengguna.
                  </p>
                </li>
              </ol>
            </li>
        ...
        <div class="mt-3">
          ...
          <ol class="sf-text">
            ...
            <li>
              ...
              <ol class="sf-text">
                <li>
                  <p class="sf-text-justify">pada waktu penerimaan sudah dimiliki oleh Pengguna selaku penerima;</p>
                </li>
                <li>
                  <p class="sf-text-justify">
        ...
        <div class="mt-3">
          ...
          <ol class="sf-text">
            <li>
              <p class="sf-text-justify">
                Syarat dan Ketentuan ini diatur dan ditafsirkan menurut hukum yang berlaku di negara Republik Indonesia.
              </p>
            </li>
            <li>
              <p class="sf-text-justify">
