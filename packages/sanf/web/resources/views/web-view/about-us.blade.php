    ...
    <div class="sf-container">
        <div class="sf-content">
            ...
            <div class="mt-4 mb-0">
                ...
                <p class="sf-text">
                    Berdasarkan Akta tertanggal 29-05-2015 (duapuluh sembilan Mei dua ribu lima belas) nomor 78, yang
                    dibuat
                    dihadapan KUMALA TJAHJANI WIDODO, Sarjana Hukum, Magister Hukum, Magister Kenotariatan, Notaris di
                    Jakarta,
                    yang telah disetujui oleh Menteri Hukum dan Hak Asasi Manusia Republik Indonesia melalui Surat
                    Keputusan
                    ...
                    12-06-2015 (duabelas Juni duaribu limabelas) nomor AHU-AH.01.03-0940743, Perseroan dapat
                    melaksanakan
                ...
                <ol type="a" class="sf-list-style">
                    <li>
                        ...
                        <ol type="1" class="sf-list-style">
                            ...
                            <li>Anjak Piutang Dengan Pemberian Jaminan Dari Penjual Piutang (Factoring With Recourse).
                            </li>
                            <li>Anjak Piutang Tanpa Pemberian Jaminan Dari Penjual Piutang (Factoring Without
                                Recourse).
                            </li>
                            <li>Fasilitas Modal Usaha; dan/atau.</li>
                            <li>Pembiayaan lain setelah terlebih dahulu mendapatkan persetujuan dari Otoritas Jasa
                                Keuangan.
                            </li>
                        </ol>
                    ...
                    <li class="mt-3">
                        Menjalankan usaha-usaha dalam bidang Pembiayaan Multiguna, yaitu pembiayaan untuk pengadaan
                        barang
                        dan/atau jasa yang diperlukan oleh debitur untuk pemakaian/konsumsi dan bukan untuk keperluan
                        usaha (aktivitas produktif) dalam jangka waktu yang diperjanjikan, yang wajib dilakukan dengan
                        cara:
            ...
            <div class="mt-3">
                ...
                <div class="sf-social-media mt-2">
                    <a href="https://www.sanf.co.id" target="_blank" rel="noopener noreferrer"><img
                            src="{{ asset('assets/svg/web.svg') }}" alt="SANFIND Web" draggable="false"/></a>
                    <a href="https://www.instagram.com/sanf_official" target="_blank" rel="noopener noreferrer"><img
                            src="{{ asset('assets/svg/ig.svg') }}" alt="SANFIND Instagram" draggable="false"/></a>
                    <a href="https://www.linkedin.com/company/sanf-astra/?viewAsMember=true" target="_blank"
                       rel="noopener noreferrer"><img src="{{ asset('assets/svg/linkedin.svg') }}"
                                                      alt="SANFIND Linkedin" draggable="false"/></a>
                </div>
            </div>
            <div class="mt-3">
