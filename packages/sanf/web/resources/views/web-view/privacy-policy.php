        ...
        <div class="sf-text">
          ...
          <div class="mt-3">
            ...
            <ol>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <p class="sf-text-justify">
                      Memproses partisipasi Pengguna dalam setiap kegiatan produksi, kontes, permainan, promosi, jajak pendapat maupun survei;
                    </p>
                  </li>
                  <li>
                    <p class="sf-text-justify">
                      Memahami dan menganalisa data dan/atau pola penggunaan dan penjualan produk dan layanan terkait kebutuhan dan preferensi;
                    </p>
                  </li>
                  <li>
                    <p class="sf-text-justify">
                  ...
                  <li>
                    <p class="sf-text-justify">
                      Mengembangkan, meningkatkan dan menyediakan produk dan layanan yang sesuai dengan kebutuhan Pengguna;
                    </p>
                  </li>
                  <li>
                    <p class="sf-text-justify">
                  ...
                  <li>
                    <p class="sf-text-justify">
                      Setiap tujuan lain yang Kami beritahukan kepada Pengguna pada saat mendapatkan persetujuan Pengguna; dan/atau
                    </p>
                  </li>
                  <li>
                    <p class="sf-text-justify">
            ...
            <ul>
              <li>
                <p class="sf-text-justify">
                  Perusahaan riset dan pemasaran terkait promosi produk/layanan Kami yang sudah memiliki perjanjian sebelumnya;
                </p>
              </li>
              <li>
              ...
              <li>
                <p class="sf-text-justify">
                  Perusahaan penyedia layanan lainnya yang terkait dengan produk dan layanan yang ditawarkan dalam Aplikasi;
                </p>
              </li>
              <li>
                <p class="sf-text-justify">
                  Penasihat profesional dan auditor eksternal, termasuk penasihat hukum, penasihat keuangan dan konsultan lainnya;
                </p>
              </li>
              <li>
                <p class="sf-text-justify">
