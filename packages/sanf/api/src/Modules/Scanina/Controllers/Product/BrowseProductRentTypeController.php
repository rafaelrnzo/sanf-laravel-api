...
use Sanf\Core\Modules\Scanina\Services\GuzzleBrowseProductFilterTypeService;

class BrowseProductRentTypeController extends RestApiController
{
    public function __invoke(Request $request, Guard $userAuth, GuzzleBrowseProductFilterTypeService $service)
    {
