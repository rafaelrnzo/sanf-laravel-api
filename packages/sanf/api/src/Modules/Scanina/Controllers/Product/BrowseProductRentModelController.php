...
use Sanf\Core\Modules\Scanina\Services\GuzzleBrowseProductFilterModelService;

class BrowseProductRentModelController extends RestApiController
{
    public function __invoke(Request $request, Guard $userAuth, GuzzleBrowseProductFilterModelService $service)
    {
        ...
        $productFilterTypeRequestDto = new BrowseProductFilterRequestDto(
            $queryParam + [
                'user_id' => $userAuth->id(),
        ...
        $result = $service->execute($productFilterTypeRequestDto);
