...
namespace Sanf\Api\Modules\Notification\Controllers;
...
//    public function getBrowse(Guard $auth, Request $request, BrowseNotificationByUserService $service)
    public function getBrowse(Guard $auth, Request $request)
    {
...
//
//        return fractal($result->data, new NotificationSimpleTransformer())
