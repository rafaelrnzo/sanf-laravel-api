...
Route::group(['prefix' => 'v1', 'middleware' => 'auth'], function () {
    ...
    Route::get('users/financing-applications', ['as' => 'financing-applications.list', 'uses' => 'Financing\Controllers\FinancingApplicationByUserController@getList']);
    Route::get('users/financing-applications/{xid}', ['as' => 'financing-applications.detail', 'uses' => 'Financing\Controllers\FinancingApplicationByUserController@getDetail']);
